jQuery(document).ready(function ($) {
    ...
    /* Sticky Menu */
    if (OmkarCoachingObj.stickyMenu == 1 || OmkarCoachingObj.stickyMenu == 'on') {
    ...
    if (typeof $.fn.countdown == 'function') {
        try {
            var eventCountdownTime = $('#event-countdown').data('time'),
                day = (OmkarCoachingObj.day == 'Day') ? 'Day%!D' : OmkarCoachingObj.day,
                hour = (OmkarCoachingObj.hour == 'Hour') ? 'Hour%!D' : OmkarCoachingObj.hour,
                minute = (OmkarCoachingObj.minute == 'Minute') ? 'Minute%!D' : OmkarCoachingObj.minute,
                second = (OmkarCoachingObj.second == 'Second') ? 'Second%!D' : OmkarCoachingObj.second;
...
function eikra_content_load_scripts() {
    ...
    if (typeof $.fn.countdown == 'function') {
        try {
            var day = (OmkarCoachingObj.day == 'Day') ? 'Day%!D' : OmkarCoachingObj.day,
                hour = (OmkarCoachingObj.hour == 'Hour') ? 'Hour%!D' : OmkarCoachingObj.hour,
                minute = (OmkarCoachingObj.minute == 'Minute') ? 'Minute%!D' : OmkarCoachingObj.minute,
                second = (OmkarCoachingObj.second == 'Second') ? 'Second%!D' : OmkarCoachingObj.second;
...
(function ($) {
    ...
    $(window).on('load', function () {
        ...
        $('#site-navigation .menu, .widget_nav_menu .menu, .rt-wid-menu .menu').onePageNav({
            extraOffset: OmkarCoachingObj.extraOffset,
        });

        // Onepage Nav on meanmenu
        $('#meanmenu .menu').onePageNav({
            extraOffset: OmkarCoachingObj.extraOffsetMobile,
            end: function () {
...
function rdtheme_sticky_header() {
    ...
    if (OmkarCoachingObj.headerStyle == 3 || OmkarCoachingObj.headerStyle == 7) {
        sticky.find('.header-firstrow, .menu-sep').remove();
    }

    if (OmkarCoachingObj.headerStyle == 4) {
    ...
    if (OmkarCoachingObj.hasAdminBar == 1 && screenWidth > 600) {
